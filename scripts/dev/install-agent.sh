...
UMask=0077
ExecStart=/usr/local/libexec/simplus-dev/simplus-agent --socket /run/simplus-agent-dev/simplus-agent.sock --sim-aka-socket /run/simplus-agent-dev/sim-aka.sock --identity-key /var/lib/simplus-agent-dev/.identity-key-v1 --directory-mode 0750 --socket-mode 0660 --socket-gid $socket_gid --allowed-uid 0 --allowed-uid $developer_uid --scan-interval 500ms
Restart=on-failure
RestartSec=2s
