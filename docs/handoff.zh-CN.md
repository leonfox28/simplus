...
> 更新：2026-08-05
>
> 状态：V1 管理面与 Host VoWiFi 常驻运行纵切已完成；非商业许可证和公开文档边界已经确定，正在准备脱敏后的首次公开发布。
...
1. 复核发布产物中的第三方许可证、源码提供义务和 notice；
2. 从脱敏后的当前工作树创建全新 Git 根提交，不复制现有私人开发历史；
3. 对新工作树、生成物和完整新历史运行 secret scan，并人工复核发布文件；
4. 经仓库所有者确认后创建公开远程；
5. 后续真实短信、电话、媒体或 eUICC 写能力必须分别建立决策、实现与获准 HIL。
