...
> 更新：2026-08-06
>
> 状态：V1 管理面、持久模组/线路层与 Host VoWiFi 常驻运行纵切已完成；SMS over IMS 真实入站、Web/API 异步 `sent` 提升、单段与两段 UCS-2 自回环，以及自动重连后再次收发均已完成。
