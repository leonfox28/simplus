...
| [Application Boundaries](./application-boundaries.md) | Typed ports, background coordination/realtime policy, stable business identity, hardware adapters, fail-closed behavior, and side-effect ordering |
