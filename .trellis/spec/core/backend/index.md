...
| [Application Boundaries](./application-boundaries.md) | Typed ports/values, explicit Setup and Mihomo supervisor composition, background coordination/realtime policy, stable business identity, hardware adapters, fail-closed behavior, and side-effect ordering |
